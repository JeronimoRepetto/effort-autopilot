...
- 210 local non-billable tests; a zero-inference diagnostic proves the whole pipeline against the installed CLI without a single model call.
...
cd effort-autopilot
npm install
npm test                                   # 210 local tests, no Claude calls
