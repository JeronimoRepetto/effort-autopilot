...
6. README and [INSTALL.md](INSTALL.md) describe only shipped behavior; platform support matrix is current (macOS hardware re-verification of the 2026-08-23 IPC/startup fixes still pending unless proven).
